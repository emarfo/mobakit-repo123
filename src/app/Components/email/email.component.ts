...
export class EmailComponent implements OnInit {
  ...
  CustomerEmail(regForm: any) {
    ...
    this.http.post('http://mobikart-alb-2042069316.us-east-1.elb.amazonaws.com/sendEmail', JSON.stringify(this.model), { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) }).subscribe((res) => {
      this.result = res
